...
import {CircleCont2} from './CircleCont';

WinningSection.propTypes = {
...
export default function WinningSection({myChoice, opponentChoice, setMyChoice}){
   ...
   // const [winStatus, setWinStatus] = useState('');
    ...
    if(opponentChoice === 'paper')
        ...
        else if(myChoice === 'rock' && opponentChoice === 'paper' || myChoice === 'scissors' &&
            opponentChoice === 'rock' || myChoice === 'paper' && opponentChoice === 'scissors')
            {
                winStatus = 'YOU LOSE';
